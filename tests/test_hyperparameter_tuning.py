...
class TestHyperparameterTuning(unittest.TestCase):
    ...
    def test_grid_search(self):
        ...
        results = grid_search('q_learning', param_grid, num_episodes=10, eval_episodes=5)
    ...
    def test_random_search(self):
        ...
        results = random_search('q_learning', param_ranges, num_iterations=5, num_episodes=10, eval_episodes=5)
        self.assertIsInstance(results, dict)
        self.assertIn('params', results)
        self.assertIn('performances', results)
        self.assertIn('best_params', results)
    ...
    def test_bayesian_optimization(self):
        ...
        results = bayesian_optimization('q_learning', param_ranges, n_trials=5, num_episodes=10, eval_episodes=5)
        self.assertIsInstance(results, dict)
